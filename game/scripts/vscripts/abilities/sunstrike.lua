...
function sun_strike_charge( keys )
	...
	local delay = ability:GetLevelSpecialValueFor("delay")
	local area_of_effect = ability:GetLevelSpecialValueFor("area_of_effect")
	local vision_duration = ability:GetLevelSpecialValueFor("vision_duration") 
	local vision_distance = ability:GetLevelSpecialValueFor("vision_distance") 
