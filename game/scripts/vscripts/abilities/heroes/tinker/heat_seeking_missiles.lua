function heat_seeking_missile_seek_targets( keys )
	...
	local units = FindUnitsInRadius(
		caster:GetTeamNumber(), caster:GetAbsOrigin(), caster, radius, DOTA_UNIT_TARGET_TEAM_ENEMY, targetType, targetFlag, FIND_CLOSEST, false)
	print('Firing heat seeking missile')
