...
function sun_strike_charge( keys )
	...
	local area_of_effect = ability:GetLevelSpecialValueFor("area_of_effect", 0)
	local vision_duration = ability:GetLevelSpecialValueFor("vision_duration", 0) 
	local vision_distance = ability:GetLevelSpecialValueFor("vision_distance", 0) 
